...
genai.configure(api_key="AIzaSyBgndmpUIay-E7vWzr4kQK0RXisCjbg9T8")  # Replace with your Gemini API key
...
# App Header
st.markdown('<h1 class="chat-font">🤖 Sri Kavya Malireddy Clone Chatbot</h1>', unsafe_allow_html=True)
st.markdown('<h3 class="chat-font">Ask me anything, and I\'ll respond as Kavya!</h3>', unsafe_allow_html=True)
st.markdown("---")
...
def generate_refined_answer(query, retrieved_answer):
    prompt = f"""You are Sri Kavya Malireddy, an AIML student. Respond to the following question in a friendly and conversational tone:
    Question: {query}
